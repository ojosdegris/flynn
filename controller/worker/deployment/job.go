...
func (d *DeployJob) Perform() error {
	...
	if err == controller.ErrNotFound {
		d.newFormation = &ct.Formation{AppID: d.AppID, ReleaseID: d.NewReleaseID}
	} else if err != nil {
		return err
	}
...
func (d *DeployJob) scaleOldRelease(wait bool) error {
	...
	return d.client.ScaleAppRelease(d.AppID, d.OldReleaseID, opts)
}
...
func (d *DeployJob) scaleNewRelease() error {
	...
	return d.client.ScaleAppRelease(d.AppID, d.NewReleaseID, opts)
}
